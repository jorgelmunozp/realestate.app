      ...
      <div className="index-content">
        ...
        <div className="index-grid">
          {properties
            ...
            .map((property, index) => (
              <div key={`property${index}`} className="index-property-card" onClick={() => handleOpenProperty(property.idProperty)}>
                <img className="index-property-card-img" src={property.images[0]?.file} alt={`property${index}`} />
