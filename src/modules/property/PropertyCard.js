export const PropertyCard = ({ property, onClick }) => {
  ...
  return (
    <div className="index-property-card" onClick={onClick}>
      {imageFile ? <img className="index-property-card-img" src={`data:image/jpg;base64,${imageFile}`} alt={property.name} loading="lazy" /> : <div className="no-image">Sin imagen</div>}
